import{R as e}from"./iframe-UCKTa6BV.js";import{D as f}from"./data-editor-all-C2YstsbC.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-CTAEJKt0.js";import{G as y}from"./image-window-loader-BIT7AnPH.js";import{S as W}from"./story-utils-DCiOTirX.js";import{r as D}from"./throttle-DRnjqVFL.js";import{y as E}from"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./flatten-wdCZvo8x.js";import"./scrolling-data-grid-waVn8UEN.js";import"./marked.esm-B58ZjuzW.js";import"./throttle--dN168Gr.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
