import{R as e}from"./iframe-wwk7Lk2P.js";import{D as f}from"./data-editor-all-DwqVeZ3N.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-BW9-Tvr5.js";import{G as y}from"./image-window-loader-BMy8zglW.js";import{S as W}from"./story-utils-CydlHlgj.js";import{r as D}from"./throttle-Br8JCf9s.js";import{y as E}from"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./flatten-rDCQVmTw.js";import"./scrolling-data-grid-BzfoJGxP.js";import"./marked.esm-DVw-gq9i.js";import"./throttle--dN168Gr.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
