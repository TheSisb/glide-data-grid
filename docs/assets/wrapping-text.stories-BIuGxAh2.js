import{R as e}from"./iframe-DDQQ0Vrs.js";import{D as f}from"./data-editor-all-WfwmghEn.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-C70ZVbBO.js";import{G as y}from"./image-window-loader-mJd1ySGt.js";import{S as W}from"./story-utils-Fo5kT6Ca.js";import{r as D}from"./throttle-BwIf-uOO.js";import{y as E}from"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./flatten-rrhK1q8h.js";import"./scrolling-data-grid-DrsOBUUE.js";import"./marked.esm-BilUkw4s.js";import"./throttle--dN168Gr.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
