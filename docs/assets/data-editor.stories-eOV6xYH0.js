import{j as a}from"./marked.esm-I79JNzkl.js";import"./index-KtDdPitk.js";import{B as Me}from"./story-utils-yBezD1KV.js";import{C,G as i}from"./image-window-loader-7QSf2mqD.js";import{D as c}from"./data-editor-all-lNcwtxR7.js";import"./throttle-UPaD_CsS.js";import"./_baseIteratee-MFXT5464.js";import"./iframe-aQXDtyj2.js";import"../sb-preview/runtime.js";import"./flatten-5Fd1fcTu.js";import"./scrolling-data-grid-AYGLF58x.js";const{useState:d,useCallback:m,useMemo:g}=__STORYBOOK_MODULE_ADDONS__,Fe={title:"Tests/TestCases",decorators:[e=>a(Me,{width:1e3,height:800,children:a(e,{})})]};function w([e,t]){return e===0?{kind:i.RowID,data:`RowID ${e}, ${t}`,allowOverlay:!1}:e===1?{kind:i.Bubble,data:[`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`],allowOverlay:!0}:e===2?{kind:i.Image,data:["https://i.imgur.com/5J0BftG.jpg","https://preview.redd.it/7jlqkp2cyap51.jpg?width=575&auto=webp&s=26fa9ed15b16fb450ee08ed1f2f0ccb5e0223581"],allowOverlay:!0,readonly:!1}:e===3?{kind:i.Markdown,data:`## Markdown has titles
